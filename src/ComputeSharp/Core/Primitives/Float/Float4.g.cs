...
namespace ComputeSharp
{
    ...
    public unsafe partial struct Float4 : IFormattable
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ref float W => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Unsafe.AsRef(in this.w), 1));
        ...
        /// </summary>
        public readonly ref float A => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Unsafe.AsRef(in this.w), 1));
